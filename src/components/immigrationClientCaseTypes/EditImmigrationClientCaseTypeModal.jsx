...
export default function EditImmigrationClientCaseTypeModal({
  caseType,
  onClose,
}) {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      await api.put(
        `${GlobalConfig.apiUrl}/v1/immigration-client-case-types/${caseType.id}`,
        data
      );
  ...
  return (
    <Modal onClose={onClose}>
      ...
      >
        <h2 className="text-lg font-bold">Edit Immigration Client Case Type</h2>
